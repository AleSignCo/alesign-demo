  ...
  return [
    ...
    },
    {
      ...
      p: [
        ...
        abon
          ? `Plata se face în avans, lunar. Prima lună se plătește ${cum}. Lunile următoare se plătesc la aceeași zi a fiecărei luni${cuCard ? ': automat, dacă s-a ales cardul, sau pe baza facturii, în 5 zile lucrătoare de la emitere, dacă s-a ales transferul' : ', pe baza facturii, în 5 zile lucrătoare de la emitere'}.`
          : `Plata se face integral, ${cum}. Lucrul începe în ziua în care plata este confirmată.`,
